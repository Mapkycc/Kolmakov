...
from task3 import GraphData, Vacancy
...
class SalaryTest(TestCase):
    ...
    def test_convert_rub(self):
        self.assertEqual(data_vacancies[0].salary.convert_rub(), 15000)
        self.assertEqual(data_vacancies[1].salary.convert_rub(), 89850.0)
